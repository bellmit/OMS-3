package com.baiyang.oms.config.web;

import com.baiyang.oms.config.properties.GunsProperties;
import com.baiyang.oms.core.intercept.GunsUserFilter;
import com.baiyang.oms.core.shiro.ShiroDbRealm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(DefaultWebSecurityManager securityManager) {
        ...
        hashMap.put("/soOrder/delStatus", "anon");
        hashMap.put("/**", "user");
        hashMap.put("/tempSo/catchOrder", "anon");
