...
import com.baiyang.oms.core.util.Contrast;
...
public class LogAop {
    ...
    @Pointcut(value = "@annotation(com.baiyang.oms.core.common.annotion.BussinessLog)")
...
System.out.println("bussinessName===="+bussinessName);
        //如果涉及到修改,比对变化
        String msg;
