...
//        return tempSoItemService.getTemSoItemListByOrderCode(condition);
        ShiroUser shiroUser = ShiroKit.getUser();
        Integer tenantId = shiroUser.getTenantId();
        List<Map<String, Object>> tempSoItemList = tempSoItemService.selectTemSoItemListByOrderCode(condition,tenantId);
        return super.warpObject(new TempSoItemWarpper(tempSoItemList));
    }
