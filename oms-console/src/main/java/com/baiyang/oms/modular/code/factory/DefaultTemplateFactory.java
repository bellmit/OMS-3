package com.baiyang.oms.modular.code.factory;


import com.baiyang.oms.OmsConsoleApplication;
import com.baiyang.oms.core.CoreFlag;
...
public class DefaultTemplateFactory {
    ...
    public static GenQo getDefaultParams(){
        ...
        genQo.setProjectPackage(OmsConsoleApplication.class.getPackage().getName());
