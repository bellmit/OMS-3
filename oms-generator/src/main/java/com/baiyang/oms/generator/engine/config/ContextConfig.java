package com.baiyang.oms.generator.engine.config;
...
public class ContextConfig {
    ...
    private String proPackage = "com.baiyang.oms.admin";
    private String coreBasePackage = "com.baiyang.oms.core";
    private String modelPackageName = "com.baiyang.oms.modular.system.model";        //model的包名
    private String modelMapperPackageName = "com.baiyang.oms.modular.system.dao";    //model的dao
