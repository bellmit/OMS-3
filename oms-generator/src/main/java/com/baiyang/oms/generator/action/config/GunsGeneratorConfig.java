package com.baiyang.oms.generator.action.config;
...
public class GunsGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void dataSourceConfig() {
        ...
        dataSourceConfig.setPassword("changer123");
        dataSourceConfig.setUrl("jdbc:mysql://192.168.0.112:3306/oms?characterEncoding=utf8");
    }
    ...
    protected void packageConfig() {
        ...
        packageConfig.setEntity("com.baiyang.oms.admin.common.persistence.model");
        packageConfig.setMapper("com.baiyang.oms.admin.common.persistence.dao");
        packageConfig.setXml("com.baiyang.oms.admin.common.persistence.dao.mapping");
    }

    protected void contextConfig() {
        contextConfig.setProPackage("com.baiyang.oms.admin");
        contextConfig.setCoreBasePackage("com.baiyang.oms.core");
