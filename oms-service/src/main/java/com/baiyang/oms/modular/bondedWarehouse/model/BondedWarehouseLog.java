package com.baiyang.oms.modular.bondedWarehouse.model;
 ...
 * @Date:2018/10/17
 */
@TableName("bondedwarehouse_log")
public class BondedWarehouseLog extends Model<BondedWarehouseLog> {

    private static final long serialVersionUID = 1L;

    public BondedWarehouseLog() {

    }

    public BondedWarehouseLog(String msgType, String content, String status) {
        super();
