...
public class NameUtil {
    ...
    //获取报关文件的名称
    public static String getCustomName(String guid,String CustomMessage) {
...
//		String guid =  UUID.randomUUID().toString().toUpperCase();
        ...
        return CustomMessage + guid + "_" + time + ".xml";
    }

    //获取报检文件的名称
    public static String getAasiqName(String guid,String CustomMessage) {
...
//		String guid = UUID.randomUUID().toString().replaceAll("-", "").toUpperCase();
    ...
    public static void main(String[] args) {
        System.out.println(getCustomName("KYQ84NBUQIM8OK8G58F5C87AF193741I",CustomTypeEnum.CUSTOM_ORDER.getMessage()));
    }
}
